			...
			<div>
				<div>
					...
					<ul>
						...
						<h6>
							Step # 5: Click on Choose File in Select Document, and select the document from your system
							you want to upload
						</h6>
						...
						<h6>
							Step # 8: In Fields Area, Click on "Select Template from List as per your needs",and then
